...
void spi_init(void)
{
		...
		SPCON |= 0x10;// enable master
SPCON |= 0x20;		//ss bar disabled 
		SPCON |= 0x03;	// spr1 and spr0 = 1
	SPCON &= 0x7F;	// spr2 = 0
	...
	SPCON |= 0x40;		// enable spen																				//Master mode
		//P1 &= 0xEF;																									//Disable SSBAR ,P1.1(SSBAR) is available as standard I/O pin 
